...
if __name__ == '__main__':
    polynomial_input = input("Enter the coefficients of the polynomial separated by spaces: ")
    arr2 = [int(x) for x in polynomial_input.split()]
    result = RouthHurwitz(arr2)
    printRouthArray(result)
